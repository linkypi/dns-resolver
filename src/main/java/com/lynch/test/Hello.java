...
public class Hello {
    ...
    public interface JnaLibrary extends Library {
        ...
        void resolve(String hostName, JnaLibrary.DnsCallback callBack);
        ...
        public interface DnsCallback extends Callback {
            void invoke(int errCode, int type);
//            void invoke(int errCode, int type, int count, int ttl, String originHost, List<String> ipv4Addrs);
        }
    }
...
//        testPointer();
    ...
    public static void testCallback() {
        // c++ output:
        // bool: 255 in true
        JnaLibrary.INSTANCE.resolve("wwww.xxx.com",
                (errCode, type) -> {
